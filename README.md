...
- [x] **Login placeholder** - I added a input tag for the password and email of the user, which will allow them to log into the webpage. There is also a placeholder on the `entry.html` page which shows the username when logged in.
