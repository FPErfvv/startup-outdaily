  ...
  return (
        <main className="container-fluid px-0 flex-grow-1 flex-shrink-1">
            <div className="d-flex flex-column flex-md-row align-items-stretch">
                {currentPage === 'unauthenticated' && <Unauthenticated onPageChange={setCurrentPage} setUsername={setUsername}/>}
                {currentPage === 'register' && <Register onPageChange={setCurrentPage} setUsername={setUsername}/>}
                {currentPage === 'forgotPassword' && <ForgotPassword onPageChange={setCurrentPage} />}
                {currentPage === 'authenticated' && <Authenticated onPageChange={setCurrentPage} username={username}/>}
